...
const { DatabaseConnection } = require(path.resolve('./src/database/core/connection.ts'));
const { TenantsRepository } = require(path.resolve('./src/database/repositories/tenants.ts'));
const { TenantUsersRepository } = require(path.resolve('./src/database/repositories/tenant-users.ts'));
